...
//Global variables
var video = $('#video')[0];
//where we will put & test our video output
var stream = null;
var camDevices = [];
var currentScan = 0;
var currentDevice = 0;
...
function gotDevices(deviceInfos) {
    ...
    if (camDevices.length > 0) {
        ...
        var res = "null";
        $('#ress').append(`<span class="result1"> No Camera Device Found !</span>`);
    }
}
...
function gum(device) {
    ...
    setTimeout(function() {
        navigator.mediaDevices.getUserMedia(constraints).then(gotStream).catch(function(error) {
